...
export default function ModernTasksPage({ user }: ModernTasksPageProps) {
  ...
  return (
    <ModernLayout user={user} title="Gestion des tâches">
      <div className="mb-6 flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900">Gestion des tâches</h1>
        <button className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors flex items-center">
